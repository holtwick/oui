...
test.describe('Demo Component Interactions', () => {
  ...
  test('button demo has interactive elements', async ({ page }) => {
    ...
    console.log(`Demo buttons: ${demoButtonCount}, All buttons: ${allButtonCount}`)
  ...
  test('input demo has form elements', async ({ page }) => {
    ...
    console.log(`Demo inputs: ${demoInputCount}, All inputs: ${allInputCount}`)
    ...
    if (targetCount > 0) {
      ...
      console.log('No inputs found in input demo - this may be expected')
    }
  })
})
